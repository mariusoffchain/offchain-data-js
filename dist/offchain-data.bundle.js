...
var OCMData=(()=>{var H=[{id:"btc-price",title:"Bitcoin Price",subtitle:"BTC/USD spot price",category:"market",type:"line",api:"price",unit:"$",source:"CoinGecko"},{id:"market-cap",title:"Market Capitalization",subtitle:"Total BTC market value",category:"market",type:"area",api:"marketcap",unit:"$T",source:"CoinGecko"},{id:"volume",title:"24h Trading Volume",subtitle:"Aggregate spot volume",category:"market",type:"bar",api:"volume",unit:"$B",source:"CoinGecko"},{id:"dominance",title:"BTC Dominance",subtitle:"Share of total crypto market cap",category:"market",type:"line",api:"dominance",unit:"%",source:"CoinGecko"},{id:"hashrate",title:"Network Hashrate",subtitle:"Total computational power",category:"mining",type:"line",api:"hashrate",unit:"EH/s",source:"mempool.space"},{id:"difficulty",title:"Mining Difficulty",subtitle:"Adjusted every 2,016 blocks",category:"mining",type:"line",api:"difficulty",unit:"T",source:"mempool.space"},{id:"block-fees",title:"Block Fees",subtitle:"Average fees per block",category:"mining",type:"bar",api:"fees",unit:"BTC",source:"mempool.space"},{id:"hashprice",title:"Hash Price",subtitle:"Daily revenue per TH/s",category:"mining",type:"line",api:"hashprice",unit:"$/TH",source:"mempool.space"},{id:"active-addresses",title:"Active Addresses",subtitle:"Unique addresses used daily",category:"on-chain",type:"area",api:"addresses",unit:"K",source:"Coin Metrics"},{id:"lth-supply",title:"Long-Term Holder Supply",subtitle:"BTC held >155 days",category:"on-chain",type:"area",api:"lth",unit:"M BTC",source:"Glassnode"},{id:"exchange-balance",title:"Exchange Balances",subtitle:"Total BTC on exchanges",category:"on-chain",type:"line",api:"exchange",unit:"M BTC",source:"Coin Metrics"},{id:"nvt",title:"NVT Ratio",subtitle:"Network Value to Transactions",category:"on-chain",type:"line",api:"nvt",unit:"",source:"Glassnode"},{id:"mempool-size",title:"Mempool Size",subtitle:"Pending transactions in vBytes",category:"mempool",type:"area",api:"mempool",unit:"MB",source:"mempool.space"},{id:"fee-rates",title:"Fee Rate Distribution",subtitle:"sat/vB by confirmation priority",category:"mempool",type:"bar",api:"feerates",unit:"sat/vB",source:"mempool.space"},{id:"tx-per-second",title:"Transactions Per Second",subtitle:"On-chain throughput",category:"mempool",type:"line",api:"tps",unit:"tx/s",source:"Coin Metrics"},{id:"block-weight",title:"Average Block Weight",subtitle:"How full are Bitcoin blocks?",category:"mempool",type:"bar",api:"blockweight",unit:"MWU",source:"mempool.space"}];var l={accent:"#F7931A",ink:"#1a1a1a",paper:"#FAF7F1",muted:"rgba(128,128,128,0.5)",grid:"rgba(128,128,128,0.12)",heading:"'Oswald', 'Arial Narrow', sans-serif",body:"'Spectral', Georgia, serif",line:"light-dark(#1a1a1a, #f2f2f2)",lineFill:"light-dark(#1a1a1a, #f2f2f2)",shadow:"light-dark(rgba(0,0,0,0.32), rgba(255,255,255,0.20))",textAdaptive:"light-dark(#1a1a1a, #ffffff)",textAdaptiveInverse:"light-dark(#ffffff, #1a1a1a)",textAdaptiveMuted:"light-dark(rgba(26,26,26,0.55), rgba(255,255,255,0.55))"},ie={"1D":24,"1W":7,"1M":30,"3M":90,"1Y":365,ALL:730};var M="https://ocm-proxy.offchainmedia.workers.dev",ne="",Ee="https://community-api.coinmetrics.io/v4/timeseries/asset-metrics",Ae=3.125,Be=144,L={};function b(e,t,o,i,n){let s=o,r=e,d=Date.now();return Array.from({length:t},(m,c)=>(r=(r*9301+49297)%233280,s+=Math.sin(c*.5+e)*i+n,s=Math.max(o*.3,s),{ts:d-(t-c)*864e5,v:s}))}var ae={price:()=>b(5,365,85e3,4e3,120),marketcap:()=>b(7,365,16e11,8e10,3e9),volume:()=>b(13,365,35e9,8e9,1e8),dominance:()=>b(6,365,55,3,.02),hashrate:()=>b(3,365,600,25,.6),difficulty:()=>b(9,52,80,5,.15),fees:()=>b(11,90,.15,.05,.001),hashprice:()=>b(12,180,.042,.008,1e-4),addresses:()=>b(14,365,9e5,8e4,500),lth:()=>b(13,365,14.2,.3,.003),exchange:()=>b(15,365,2.8,.04,-.001),nvt:()=>b(16,365,65,8,.02),mempool:()=>b(17,90,35,18,.05),feerates:()=>b(18,90,15,10,.02),tps:()=>b(19,90,5.5,1,.002),blockweight:()=>b(20,90,3.7,.2,.001)};function O(e){let t=new Map;for(let{ts:o,v:i}of e){let n=Math.floor(o/864e5),s=t.get(n)||{sum:0,n:0};s.sum+=i,s.n+=1,t.set(n,s)}return[...t.entries()].sort((o,i)=>o[0]-i[0]).map(([o,{sum:i,n}])=>({ts:o*864e5,v:i/n}))}async function Le(){let e=await fetch(`${M}/api/v1/mining/hashrate/1y`);if(!e.ok)throw new Error(`hashrate HTTP ${e.status}`);return(await e.json()).hashrates.map(o=>({ts:o.timestamp*1e3,v:o.avgHashrate/1e18}))}async function Fe(){let e=await fetch(`${M}/api/v1/mining/difficulty-adjustments/1y`);if(!e.ok)throw new Error(`difficulty HTTP ${e.status}`);return(await e.json()).map(([o,,i])=>({ts:o*1e3,v:i/1e12})).sort((o,i)=>o.ts-i.ts)}async function Se(){let e=await fetch(`${M}/api/v1/mining/blocks/fees/1y`);if(!e.ok)throw new Error(`fees HTTP ${e.status}`);let t=await e.json();return O(t.map(o=>({ts:o.timestamp*1e3,v:o.avgFees/1e8})))}async function _e(){let e=await fetch(`${M}/api/v1/mining/blocks/fee-rates/1y`);if(!e.ok)throw new Error(`feerates HTTP ${e.status}`);let t=await e.json();return O(t.map(o=>({ts:o.timestamp*1e3,v:o.avgFee_50})))}async function De(){let e=await fetch(`${M}/api/v1/statistics/1y`);if(!e.ok)throw new Error(`mempool HTTP ${e.status}`);let t=await e.json();return O(t.map(o=>({ts:o.added*1e3,v:o.vsizes.reduce((i,n)=>i+n,0)/1e6})))}async function Pe(){let e=await fetch(`${M}/api/v1/mining/blocks/sizes-weights/1y`);if(!e.ok)throw new Error(`blockweight HTTP ${e.status}`);let t=await e.json();return O(t.weights.map(o=>({ts:o.timestamp*1e3,v:o.avgWeight/1e6})))}async function Q(e){let t=new Date,o=new Date(t-370*864e5),i=`${Ee}?assets=btc&metrics=${e}&frequency=1d&start_time=${o.toISOString().slice(0,10)}&end_time=${t.toISOString().slice(0,10)}&page_size=10000`,n=await fetch(i);if(!n.ok)throw new Error(`${e} HTTP ${n.status}`);return(await n.json()).data.map(r=>({ts:new Date(r.time).getTime(),v:parseFloat(r[e])}))}async function ze(){return(await Q("AdrActCnt")).map(({ts:e,v:t})=>({ts:e,v:t/1e3}))}async function Re(){return(await Q("TxCnt")).map(({ts:e,v:t})=>({ts:e,v:t/86400}))}async function He(){return(await Q("SplyExNtv")).map(({ts:e,v:t})=>({ts:e,v:t/1e6}))}async function je(){let[{data:e},{data:t},{data:o}]=await Promise.all([T("fees"),T("hashrate"),T("price")]),i=new Map(t.map(s=>[Math.floor(s.ts/864e5),s.v])),n=new Map(o.map(s=>[Math.floor(s.ts/864e5),s.v]));return e.map(({ts:s,v:r})=>{let d=Math.floor(s/864e5),m=i.get(d),c=n.get(d);if(m==null||c==null)return null;let p=Be*(Ae+r)*c;return{ts:s,v:p/(m*1e6)}}).filter(Boolean)}function Ge(){return[{medianFee:2.1,feeRange:[1,1.2,1.3,2,2.7,4,201],nTx:4327,totalFees:25e5,blockSize:2054070},{medianFee:1.4,feeRange:[.5,.6,.7,1,1.5,2.2,150],nTx:6755,totalFees:16e5,blockSize:1997e3},{medianFee:.6,feeRange:[.36,.4,.42,.5,.7,1,45],nTx:5777,totalFees:95e4,blockSize:1584123}]}function Ie(){let e=["F2Pool","Foundry USA","Luxor","AntPool","ViaBTC","\u24C8BTC.com"],t=Date.now();return Array.from({length:6},(o,i)=>({height:957896-i,timestamp:Math.floor((t-i*9.7*6e4)/1e3),tx_count:4362-i*235,size:1561683+i*12e3,extras:{medianFee:1.1+i*.1,feeRange:[.55-i*.02,.7,1,2,3,5,161-i*10],totalFees:1883531-i*9e4,pool:{name:e[i%e.length]}}}))}async function re(){try{let e=await fetch(`${M}/api/v1/fees/mempool-blocks`);if(!e.ok)throw new Error(`mempool-blocks HTTP ${e.status}`);return{data:await e.json(),live:!0}}catch(e){return console.warn('[data] Falling back to mock for "mempool-blocks":',e.message),{data:Ge(),live:!1}}}async function se(){try{let e=await fetch(`${M}/api/v1/blocks`);if(!e.ok)throw new Error(`blocks HTTP ${e.status}`);return{data:await e.json(),live:!0}}catch(e){return console.warn('[data] Falling back to mock for "blocks":',e.message),{data:Ie(),live:!1}}}function ce(e){let t=Math.max(0,Math.round((Date.now()-e*1e3)/6e4));return t<1?"just now":t<60?`${t} min ago`:`${Math.round(t/60)}h ago`}async function K(){if(L._market)return L._market;let e=ne?`&x_cg_demo_api_key=${ne}`:"",t=await fetch(`https://api.coingecko.com/api/v3/coins/bitcoin/market_chart?vs_currency=usd&days=365&interval=daily${e}`);if(!t.ok)throw new Error(`CoinGecko HTTP ${t.status}`);let o=await t.json();return L._market={price:o.prices.map(([i,n])=>({ts:i,v:n})),marketcap:o.market_caps.map(([i,n])=>({ts:i,v:n/1e12})),volume:o.total_volumes.map(([i,n])=>({ts:i,v:n/1e9}))},L._market}var Ne={hashrate:Le,difficulty:Fe,fees:Se,feerates:_e,mempool:De,blockweight:Pe,addresses:ze,tps:Re,exchange:He,hashprice:je,price:async()=>(await K()).price,marketcap:async()=>(await K()).marketcap,volume:async()=>(await K()).volume};async function T(e){if(L[e])return{data:L[e],live:!0};let t=Ne[e];if(t)try{let i=await t();return L[e]=i,{data:i,live:!0}}catch(i){console.warn(`[data] Falling back to mock for "${e}":`,i.message)}return{data:(ae[e]||ae.price)(),live:!1}}function j(e,t){let o=ie[t]??e.length;return e.slice(-Math.min(o,e.length))}function F(e,t){return t==="$"?e>=1e3?`$${(e/1e3).toFixed(0)}k`:`$${e.toFixed(0)}`:t==="$T"?`$${e.toFixed(2)}T`:t==="$B"?`$${e.toFixed(1)}B`:t==="EH/s"?`${e.toFixed(1)} EH/s`:t==="%"?`${e.toFixed(1)}%`:t==="M BTC"?`${e.toFixed(2)}M BTC`:t==="K"?`${(e/1e3).toFixed(0)}K`:t==="BTC"?`${e.toFixed(3)} BTC`:t==="T"?`${e.toFixed(1)}T`:e!=null?`${e.toFixed(2)}${t?" "+t:""}`:"\u2014"}function le(e,t){return e==null?"\u2014":t==="$"?`$${Math.round(e).toLocaleString("en-US")}`:t==="BTC"?`${e.toFixed(4)} BTC`:t==="K"?Math.round(e).toLocaleString("en-US"):F(e,t)}function de(e){return new Date(e).toLocaleDateString("en-GB",{day:"numeric",month:"short",year:"numeric"})}function pe(e){let t=e;return()=>(t=(t*9301+49297)%233280,t/233280)}function a(e,t={}){let o=document.createElementNS("http://www.w3.org/2000/svg",e);return Object.entries(t).forEach(([i,n])=>o.setAttribute(i,n)),o}function X(e,t=1,o=1){let i=pe(o),n=e.map(r=>({x:r.x+(i()-.5)*t,y:r.y+(i()-.5)*t}));if(n.length<2)return"";let s=`M${n[0].x.toFixed(2)},${n[0].y.toFixed(2)}`;for(let r=0;r<n.length-1;r++){let d=n[Math.max(0,r-1)],m=n[r],c=n[r+1],p=n[Math.min(n.length-1,r+2)],h=m.x+(c.x-d.x)/6,f=m.y+(c.y-d.y)/6,x=c.x-(p.x-m.x)/6,y=c.y-(p.y-m.y)/6;s+=` C${h.toFixed(2)},${f.toFixed(2)} ${x.toFixed(2)},${y.toFixed(2)} ${c.x.toFixed(2)},${c.y.toFixed(2)}`}return s}function me(e,t,o){let i=pe(Math.round(e+t)),n=i()*Math.PI,s=[];for(let r=0;r<=Math.PI*2*1.15;r+=.3){let d=o+(i()-.5)*1.5;s.push(`${(e+Math.cos(r+n)*d).toFixed(1)},${(t+Math.sin(r+n)*d).toFixed(1)}`)}return"M"+s.join(" L")}function he(e,t,o,i){let n=e.map(c=>c.v),s=Math.min(...n),r=Math.max(...n),d=r-s||1;return{points:e.map((c,p)=>({x:t.left+p/(e.length-1)*o,y:t.top+i-(c.v-s)/d*i,d:c})),min:s,max:r,range:d}}var _=680,S=380,u={top:52,right:20,bottom:46,left:52},E=_-u.left-u.right,v=S-u.top-u.bottom,qe=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],ee=5,Oe=0;function U(e,t,o,i){e.innerHTML="";let n=j(t,i);if(!n.length)return;let{points:s,min:r,max:d,range:m}=he(n,u,E,v),c=a("svg",{width:"100%",viewBox:`0 0 ${_} ${S}`,style:"display:block"}),p=a("defs"),h=a("filter",{id:"ocm-rough",x:"-5%",y:"-5%",width:"110%",height:"110%"}),f=a("feTurbulence",{type:"fractalNoise",baseFrequency:"0.012",numOctaves:"2",seed:"4",result:"n"}),x=a("feDisplacementMap",{in:"SourceGraphic",in2:"n",scale:"2",xChannelSelector:"R",yChannelSelector:"G"});h.appendChild(f),h.appendChild(x),p.appendChild(h);let y=a("filter",{id:"ocm-drop",x:"-20%",y:"-20%",width:"140%",height:"140%"}),k=a("feGaussianBlur",{in:"SourceAlpha",stdDeviation:"3",result:"blur"}),A=a("feOffset",{in:"blur",dx:"2",dy:"4",result:"off"}),$=a("feFlood",{style:`flood-color: ${l.shadow}`,result:"floodColor"}),J=a("feComposite",{in:"floodColor",in2:"off",operator:"in",result:"sh"}),G=a("feMerge");G.appendChild(a("feMergeNode",{in:"sh"})),G.appendChild(a("feMergeNode",{in:"SourceGraphic"})),y.appendChild(k),y.appendChild(A),y.appendChild($),y.appendChild(J),y.appendChild(G),p.appendChild(y);let w=a("linearGradient",{id:"ocm-vol",x1:"0",y1:"0",x2:"0",y2:"1"});w.appendChild(a("stop",{offset:"0%",style:`stop-color: ${l.lineFill}`,"stop-opacity":"0.22"})),w.appendChild(a("stop",{offset:"100%",style:`stop-color: ${l.lineFill}`,"stop-opacity":"0.02"})),p.appendChild(w);let P=a("linearGradient",{id:"ocm-ridge",x1:"0",y1:"0",x2:"0",y2:"1"});P.appendChild(a("stop",{offset:"0%","stop-color":"#fff","stop-opacity":"0.30"})),P.appendChild(a("stop",{offset:"15%","stop-color":"#fff","stop-opacity":"0"})),p.appendChild(P);let z=a("clipPath",{id:"ocm-clip"});z.appendChild(a("rect",{x:u.left,y:u.top,width:E,height:v})),p.appendChild(z),c.appendChild(p),c.appendChild(a("rect",{width:_,height:S,fill:"transparent"}));for(let C=0;C<=ee;C++){let N=u.top+C/ee*v,B=d-C/ee*m;c.appendChild(a("line",{x1:u.left,y1:N,x2:u.left+E,y2:N,stroke:l.grid,"stroke-width":"0.7","stroke-linecap":"round"}));let q=a("text",{x:u.left-8,y:N+4,"text-anchor":"end","font-family":l.body,"font-size":"12",fill:"rgba(128,128,128,0.65)","font-style":"italic"});q.textContent=B>1e9?`${(B/1e9).toFixed(0)}B`:B>1e6?`${(B/1e6).toFixed(0)}M`:B.toFixed(1),c.appendChild(q)}c.appendChild(a("line",{x1:u.left,y1:u.top+v,x2:u.left+E,y2:u.top+v,stroke:"rgba(128,128,128,0.28)","stroke-width":"1","stroke-linecap":"round"})),[0,.25,.5,.75,1].forEach(C=>{let N=Math.round(C*(n.length-1)),B=u.left+C*E,q=new Date(n[N]?.ts||Date.now()).getMonth(),oe=a("text",{x:B,y:u.top+v+18,"text-anchor":"middle","font-family":l.body,"font-size":"12",fill:"rgba(128,128,128,0.6)","font-style":"italic"});oe.textContent=qe[q],c.appendChild(oe)}),o.type==="bar"?Ue(c,p,n,r,m):Ve(c,s,t,o,n),We(c,p),c.appendChild(a("line",{x1:0,y1:S-14,x2:_,y2:S-14,stroke:l.ink,"stroke-width":"0.5",opacity:"0.3"}));let R=a("text",{x:u.left,y:S-4,"font-family":l.body,"font-size":"9",fill:"rgba(128,128,128,0.4)","font-style":"italic"});R.textContent=`Source: ${o.source}`,c.appendChild(R);let I=a("text",{x:_-u.right,y:S-4,"text-anchor":"end","font-family":l.heading,"font-size":"8",fill:"rgba(128,128,128,0.35)","letter-spacing":"0.1em"});I.textContent="OFFCHAIN.MEDIA/DATA",c.appendChild(I),e.appendChild(c)}function Ue(e,t,o,i,n){let r=(E-3*(o.length-1))/Math.max(o.length,1),d=a("g",{filter:"url(#ocm-rough)"});o.forEach((m,c)=>{let p=(m.v-i)/n*v,h=u.left+c*(r+3),f=u.top+v-p,x=c===o.length-1,y=x?l.accent:l.line,k=`ocm-bv-${c}`,A=a("linearGradient",{id:k,x1:"0",y1:"0",x2:"0",y2:"1"});A.appendChild(a("stop",{offset:"0%",style:`stop-color: ${y}`,"stop-opacity":x?"1":"0.85"})),A.appendChild(a("stop",{offset:"100%",style:`stop-color: ${y}`,"stop-opacity":x?"0.75":"0.6"})),t.appendChild(A);let $=a("g",{filter:"url(#ocm-drop)"});$.appendChild(a("rect",{x:h,y:f,width:r,height:p,rx:"1.5",fill:`url(#${k})`})),$.appendChild(a("rect",{x:h,y:f,width:r,height:Math.min(p,16),rx:"1.5",fill:"rgba(255,255,255,0.28)"})),d.appendChild($)}),e.appendChild(d)}function Ve(e,t,o,i,n){let s=X(t,1,3),r=`${s} L${t[t.length-1].x},${u.top+v} L${t[0].x},${u.top+v} Z`,d=a("g",{"clip-path":"url(#ocm-clip)"});d.appendChild(a("path",{d:r,fill:"url(#ocm-vol)"})),d.appendChild(a("path",{d:r,fill:"url(#ocm-ridge)"})),e.appendChild(d);let m=a("g",{filter:"url(#ocm-rough)","clip-path":"url(#ocm-clip)"});m.appendChild(a("path",{d:s,fill:"none",style:`stroke: ${l.line}`,"stroke-width":"2.2","stroke-linecap":"round","stroke-linejoin":"round",filter:"url(#ocm-drop)"})),t.length>12&&m.appendChild(a("path",{d:X(t.slice(-12),1,4),fill:"none",stroke:l.accent,"stroke-width":"2.5","stroke-linecap":"round",filter:"url(#ocm-drop)"})),e.appendChild(m);let c=t[t.length-1];c&&(e.appendChild(a("circle",{cx:c.x,cy:c.y,r:"4",fill:l.accent})),e.appendChild(a("path",{d:me(c.x,c.y,9),fill:"none",stroke:l.accent,"stroke-width":"1.2",opacity:"0.6","stroke-linecap":"round"})));let p=a("line",{x1:0,y1:u.top,x2:0,y2:u.top+v,stroke:l.accent,"stroke-width":"0.7","stroke-dasharray":"3,3",opacity:"0","pointer-events":"none"});e.appendChild(p);let h=a("g",{opacity:"0","pointer-events":"none"}),f=a("rect",{x:0,y:0,width:130,height:42,rx:"2",fill:l.ink}),x=a("text",{x:10,y:14,"font-family":l.body,"font-size":"10",fill:"rgba(255,255,255,0.55)","font-style":"italic"}),y=a("text",{x:10,y:32,"font-family":l.heading,"font-size":"14","font-weight":"600",fill:"#fff"});h.appendChild(f),h.appendChild(x),h.appendChild(y),e.appendChild(h);let k=a("rect",{x:u.left,y:u.top,width:E,height:v,fill:"transparent",style:"cursor:crosshair"});k.addEventListener("mousemove",A=>{let $=e.getBoundingClientRect(),J=_/$.width,G=(A.clientX-$.left)*J,w=t[0],P=1/0;t.forEach(I=>{let C=Math.abs(I.x-G);C<P&&(P=C,w=I)}),p.setAttribute("x1",w.x),p.setAttribute("x2",w.x),p.setAttribute("opacity","0.5");let z=Math.min(w.x+8,_-140),R=Math.max(w.y-52,u.top);f.setAttribute("x",z),f.setAttribute("y",R),x.setAttribute("x",z+10),x.setAttribute("y",R+14),y.setAttribute("x",z+10),y.setAttribute("y",R+32),x.textContent=de(w.d.ts),y.textContent=F(w.d.v,i.unit),h.setAttribute("opacity","1")}),k.addEventListener("mouseleave",()=>{p.setAttribute("opacity","0"),h.setAttribute("opacity","0")}),e.appendChild(k)}function We(e,t){let o=`ocmwm${Oe++}`,i=u.left+E/2,n=u.top+v/2,s=160/956,r=i-s*862,d=n-s*415,m=(x,y)=>{let k=a("clipPath",{id:o+x});k.appendChild(a("path",{d:y})),t.appendChild(k)};m("r","M726 201 L1077 201 L1077 629 L726 629Z"),m("l","M384 201 L999 201 L999 629 L384 629Z"),m("b","M934.7 537.1 L1015.5 537.1 L1015.5 628.2 L934.7 628.2Z");let c=a("g",{transform:`translate(${r.toFixed(1)},${d.toFixed(1)}) scale(${s.toFixed(4)})`,style:`fill: ${l.line}`,opacity:"0.06"}),p=a("g",{"clip-path":`url(#${o}r)`});p.appendChild(a("path",{d:"M1340.3 414.7C1340.4 296.8 1244.8 201.2 1126.9 201.3L958.4 201.4C965.7 207.3 972.8 213.7 979.6 220.5C1000.9 241.8 1018.2 265.9 1031.3 292.1L1126.8 292C1159.6 292 1190.4 304.8 1213.6 328C1236.8 351.1 1249.6 382 1249.5 414.8C1249.5 447.6 1236.7 478.4 1213.5 501.6C1190.3 524.8 1159.4 537.6 1126.7 537.6L939.8 537.7C907 537.8 876.2 525 852.9 501.8C829.8 478.6 817 447.8 817.1 415C817 399.1 820.1 383.6 825.9 369.2C814.7 359.1 800.3 353.6 785.1 353.6L735.3 353.7C729.5 373.1 726.3 393.8 726.2 415.1C726.2 533 821.8 628.6 939.7 628.5L1126.6 628.4C1244.5 628.3 1340.2 532.7 1340.3 414.7Z"})),c.appendChild(p);let h=a("g",{"clip-path":`url(#${o}l)`});h.appendChild(a("path",{d:"M746.3 610.5C725 589.2 707.5 564.8 694.2 537.9L598.1 537.9C565.3 538 534.4 525.2 511.3 502.1C488.1 478.9 475.3 448.1 475.4 415.2C475.4 382.4 488.2 351.6 511.4 328.4C534.6 305.2 565.4 292.4 598.3 292.4L785.1 292.2C817.9 292.3 848.7 305 871.9 328.2C895.1 351.4 907.8 382.2 907.8 415C907.8 430.9 904.8 446.4 899 460.8C910.2 471 924.6 476.5 939.9 476.4L989.6 476.4C995.4 456.9 998.6 436.3 998.6 414.9C998.7 297 903.1 201.4 785.2 201.5L598.3 201.6C480.3 201.7 384.6 297.3 384.6 415.3C384.5 533.3 480 628.8 598 628.8L766.2 628.6C759.4 623 752.7 616.9 746.3 610.5Z"})),c.appendChild(h),c.appendChild(a("path",{d:"M771.5 430C796.8 542.8 866.9 593.7 982.1 582.7",style:`fill:none;stroke:${l.line};stroke-width:50;stroke-linecap:butt;stroke-miterlimit:4`}));let f=a("g",{"clip-path":`url(#${o}b)`});f.appendChild(a("rect",{x:"934.7",y:"537.1",width:"80.8",height:"91.2"})),c.appendChild(f),e.appendChild(c)}function ue(e){let t=document.querySelector(".ocm-gallery-view"),o=document.querySelectorAll(".ocm-data-filters .ocm-filter-btn");if(!t||!o.length)return null;let i=document.createElement("nav");i.className="ocm-sidebar";let n=[...o].map(s=>{let r=document.createElement("div");return r.className="ocm-sidebar-item",r.textContent=s.textContent.trim(),r.dataset.filter=s.dataset.filter,s.classList.contains("ocm-filter-active")&&r.classList.add("ocm-sidebar-active"),r.addEventListener("click",()=>{n.forEach(d=>d.classList.remove("ocm-sidebar-active")),r.classList.add("ocm-sidebar-active"),e(r.dataset.filter)}),i.appendChild(r),r});return t.insertBefore(i,t.firstChild),i}var fe=!1;function ge(){if(fe)return;fe=!0;let e=document.createElement("style");e.textContent=`
  ...
  `,e.appendChild(i),e}function ke(e,t){let o=document.createElement("div");o.className=`ocm-block-cube ocm-block-cube--${e}`;let i=e==="confirmed",n=i?l.textAdaptive:"none",s=l.textAdaptive,r=a("svg",{class:"ocm-block-cube-bg",viewBox:"0 0 100 100",preserveAspectRatio:"none"});r.appendChild(a("polygon",{points:`0,${g} ${g},0 100,0 ${100-g},${g}`,style:`fill: ${i?l.textAdaptive:"none"}; opacity: ${i?"0.8":"1"}; stroke: ${s}; stroke-width: 1;`})),r.appendChild(a("polygon",{points:`${100-g},${g} 100,0 100,${100-g} ${100-g},100`,style:`fill: ${i?l.textAdaptive:"none"}; opacity: ${i?"0.6":"1"}; stroke: ${s}; stroke-width: 1;`})),r.appendChild(a("polygon",{points:`0,${g} ${100-g},${g} ${100-g},100 0,100`,style:`fill: ${n}; stroke: ${s}; stroke-width: 1;`})),o.appendChild(r);let d=document.createElement("div");d.className="ocm-block-cube-content";let m=t.range[0],c=t.range[t.range.length-1];return d.innerHTML=`
  ...
  `,o.appendChild(d),o}var V=null,W="1Y",Z=document.querySelector(".ocm-gallery-view"),Y=document.querySelector(".ocm-detail-view");function rt(){Z&&(Z.style.display=""),Y&&(Y.style.display="none"),V=null,window.scrollTo({top:0,behavior:"smooth"})}async function Me(e){V=e,W="1Y",Z&&(Z.style.display="none"),Y&&(Y.style.display=""),window.scrollTo({top:0,behavior:"smooth"}),await te(e,W)}function st(){document.querySelectorAll(".ocm-period-btn").forEach(e=>{e.addEventListener("click",async()=>{W=e.dataset.period,V&&await te(V,W)})})}function ct(){let e=document.querySelector(".ocm-back-btn");e&&e.addEventListener("click",rt)}document.addEventListener("ocm:openChart",e=>Me(e.detail));async function Te(){st(),ct(),$e(),await xe(Me)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Te):Te();})();
